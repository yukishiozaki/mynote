        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card card-new-task">
                    <div class="card-header">(編集予定)お店登録</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('store.create') }}">
                            @csrf
                            <div class="form-group">
                                <label for="store_name">(編集予定)店名</label>
                            ...
                            <div class="form-group">
                                <label for="store_adres">(編集予定)住所</label>
                            ...
                            <div class="form-group">
                                <label for="category_id">(編集予定)ジャンル</label>
                            ...
                            <button type="submit" class="btn btn-primary">(編集予定)登録</button>
                        </form>
                    </div>
                </div>
            </div>
